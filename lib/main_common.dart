import 'package:clean_bloc_template/app/view/app.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart'; // Add if Bloc is used early
import 'package:clean_bloc_template/app/di/injector.dart';
...
Future<void> mainCommon(String environment) async {
  ...
  // More setup here, like Bloc observers, etc.
   runApp(const App()); // Temporary, replace with actual App widget
}
