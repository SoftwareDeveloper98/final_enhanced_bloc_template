...
// in clean_bloc_template/test/features/home/presentation/bloc/home_bloc_test.dart.
...
class MockGetItems extends _i1.Mock implements _i4.GetItems {
  ...
  @override
  _i5.Future<_i3.Either<dynamic, List<_i6.Item>>> call(dynamic params) =>
      (super.noSuchMethod(
        Invocation.method(
          #call,
          [params],
        ),
        returnValue: _i5.Future<_i3.Either<dynamic, List<_i6.Item>>>.value(
            _FakeEither_1<dynamic, List<_i6.Item>>(
          this,
          Invocation.method(
            #call,
            [params],
      ...
      ) as _i5.Future<_i3.Either<dynamic, List<_i6.Item>>>);
}
